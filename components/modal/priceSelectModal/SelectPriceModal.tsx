...
const SelectPriceModal:FunctionComponent<SelectPriceModalProps> = ({ currentCurrency, currencies, selectCurrency }) => (
  <div className='relative'>
    ...
    <div className='absolute hidden group-hover:flex flex-col gap-2 top-16 right-1/2 translate-x-1/2 px-6 py-4 border-2 bg-secondary dark:bg-primary border-primary dark:border-secondary'>
